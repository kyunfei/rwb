          ...
          builder: (context, scrollController) {
            return ClipRRect(
              ...
              child: real.ReaderSettingsSheet(
                ...
                onChineseConverterTypeChanged: provider.setChineseConverterType,
                onFontWeightFineChanged: provider.setFontWeightFine,
                onTextBoldFineChanged: provider.setTextBoldFine,
                onTitleBoldFineChanged: provider.setTitleBoldFine,
                onTitleModeChanged: provider.setTitleMode,
                onTitleSizeChanged: provider.setTitleSize,
                onTitleTopSpacingChanged: provider.setTitleTopSpacing,
                onTitleBottomSpacingChanged: provider.setTitleBottomSpacing,
                onPaddingTopChanged: provider.setPaddingTop,
                onPaddingBottomChanged: provider.setPaddingBottom,
                onPaddingLeftChanged: provider.setPaddingLeft,
                onPaddingRightChanged: provider.setPaddingRight,
                onHeaderPaddingTopChanged: provider.setHeaderPaddingTop,
                onHeaderPaddingBottomChanged: provider.setHeaderPaddingBottom,
                onHeaderPaddingLeftChanged: provider.setHeaderPaddingLeft,
                onHeaderPaddingRightChanged: provider.setHeaderPaddingRight,
                onFooterPaddingTopChanged: provider.setFooterPaddingTop,
                onFooterPaddingBottomChanged: provider.setFooterPaddingBottom,
                onFooterPaddingLeftChanged: provider.setFooterPaddingLeft,
                onFooterPaddingRightChanged: provider.setFooterPaddingRight,
                onShowHeaderLineChanged: provider.setShowHeaderLine,
                onShowFooterLineChanged: provider.setShowFooterLine,
                onHeaderModeChanged: provider.setHeaderMode,
                onFooterModeChanged: provider.setFooterMode,
                ...
                onHeaderFontSizeChanged: provider.setHeaderFontSize,
                onFooterFontSizeChanged: provider.setFooterFontSize,
              ),
            );
          },
        );
